...
this.command = function() {
    ...
    try {
    onCommand(commandBox.value, enqueueMessage);
    } catch (x) {
        enqueueException(x);
    }
    commandBox.value = "";
...
this.onCommand = function(command, enqueueMessage) {
...
setInterval(refreshTitle, refreshTitleInterval);
